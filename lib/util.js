...
util.configure = function(options){
    this.options = options;
    this.hashprefix = options.hashprefix === undefined ? '!' : options.hashprefix;
    return this;
};
...
util.getUrl = function (req) {
    ...
    if (parts.query && parts.query.hasOwnProperty('_escaped_fragment_')) {
        ...
        if (parts.query['_escaped_fragment_'] && !Array.isArray(parts.query['_escaped_fragment_'])) {
            parts.hash = '#' + this.hashprefix + parts.query['_escaped_fragment_'];
            /*
            parts.hash = '#';
            parts.hash += this.hashprefix;
